...
export interface SchemaStringType {
    ...
    errors?: {
        ...
        pattern?: (value: string, pattern: RegExp) => ValidationError,
...
export interface SchemaIntType {
...
export type SchemaType = SchemaStringType | SchemaIntType | SchemaArrayType | SchemaObjectType | SchemaBoolType;